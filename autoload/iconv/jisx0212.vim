...
function iconv#jisx0212#new()
  return s:jisx0212.new()
endfunction

let s:jisx0212 = {}

function s:jisx0212.new()
  let obj = copy(self)
  call obj.__init__()
  return obj
endfunction

function s:jisx0212.__init__()
  " pass
endfunction

function s:jisx0212.mbtowc(mb)
  let c1 = a:mb[0]
  if (c1 == 0x22) || (c1 >= 0x26 && c1 <= 0x27) ||
    ...
    if len(a:mb) >= 2
      ...
      if c2 >= 0x21 && c2 < 0x7f
        ...
        if i < 470
          if i < 175
            let wc = self.jisx0212_2uni_page22[i-94]
          endif
        elseif i < 752
          if i < 658
            let wc = self.jisx0212_2uni_page26[i-470]
          endif
        elseif i < 1410
          if i < 1027
            let wc = self.jisx0212_2uni_page29[i-752]
          endif
        else
          if i < 7211
            let wc = self.jisx0212_2uni_page30[i-1410]
          endif
        endif
        if wc != 0xfffd
          return [2, [wc]]
...
function s:jisx0212.wctomb(wc)
  let summary = []
  if a:wc >= 0x0000 && a:wc < 0x0460
    let summary = self.jisx0212_uni2indx_page00[bitwise#rshift(a:wc, 4)]
  elseif a:wc >= 0x2100 && a:wc < 0x2130
    let summary = self.jisx0212_uni2indx_page21[bitwise#rshift(a:wc, 4)-0x210]
  elseif a:wc >= 0x4e00 && a:wc < 0x9fb0
    let summary = self.jisx0212_uni2indx_page4e[bitwise#rshift(a:wc, 4)-0x4e0]
  elseif a:wc >= 0xff00 && a:wc < 0xff60
    let summary = self.jisx0212_uni2indx_pageff[bitwise#rshift(a:wc, 4)-0xff0]
  endif
  if !empty(summary)
    let idx_indx = 0
    let idx_used = 1
    ...
    if bitwise#and(used, bitwise#lshift(1, i))
      ...
      let c = self.jisx0212_2charset[summary[idx_indx] + used]
...
let s:jisx0212.jisx0212_2uni_page22 = [
\
...
let s:jisx0212.jisx0212_2uni_page26 = [
\
\ 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd,
\ 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd,
\ 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd, 0xfffd,
...
let s:jisx0212.jisx0212_2uni_page29 = [
\
...
let s:jisx0212.jisx0212_2uni_page30 = [
\
...
let s:jisx0212.jisx0212_2charset = [
...
let s:jisx0212.jisx0212_uni2indx_page00 = [
\
...
let s:jisx0212.jisx0212_uni2indx_page21 = [
\
\ [  263, 0x0000 ], [  263, 0x0040 ], [  264, 0x0004 ],
\]

let s:jisx0212.jisx0212_uni2indx_page4e = [
\
...
let s:jisx0212.jisx0212_uni2indx_pageff = [
\
