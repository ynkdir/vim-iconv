...
function iconv#iso8859_7#new()
  return s:iso8859_7.new()
endfunction

let s:iso8859_7 = {}

function s:iso8859_7.new()
  let obj = copy(self)
  call obj.__init__()
  return obj
endfunction

function s:iso8859_7.__init__()
  " pass
endfunction

function s:iso8859_7.mbtowc(mb)
  let c = a:mb[0]
  if c < 0xa0
    return [1, [c]]
  else
    let wc = self.iso8859_7_2uni[c-0xa0]
    if wc != 0xfffd
      return [1, [wc]]
    endif
  endif
...
function s:iso8859_7.wctomb(wc)
  if a:wc < 0x00a0
    return [a:wc]
  elseif a:wc >= 0x00a0 && a:wc < 0x00c0
    let c = self.iso8859_7_page00[a:wc-0x00a0]
  elseif a:wc >= 0x0378 && a:wc < 0x03d0
    let c = self.iso8859_7_page03[a:wc-0x0378]
  elseif a:wc >= 0x2010 && a:wc < 0x2020
    let c = self.iso8859_7_page20[a:wc-0x2010]
  elseif a:wc == 0x20ac
    let c = 0xa4
  elseif a:wc == 0x20af
    let c = 0xa5
...
function s:iso8859_7.flush()
  return []
endfunction

let s:iso8859_7.iso8859_7_2uni = [
\
...
let s:iso8859_7.iso8859_7_page00 = [
...
let s:iso8859_7.iso8859_7_page03 = [
...
let s:iso8859_7.iso8859_7_page20 = [
