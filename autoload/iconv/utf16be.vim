...
function iconv#utf16be#new()
  return s:utf16be.new()
endfunction

let s:utf16be = {}

function s:utf16be.new()
  let obj = copy(self)
  call obj.__init__()
  return obj
endfunction

function s:utf16be.__init__()
  " pass
endfunction

function s:utf16be.mbtowc(mb)
  if len(a:mb) < 2
    throw "ICONV: RET_TOOFEW"
  endif
  let wc = (a:mb[0] * 0x100) + a:mb[1]
  if wc >= 0xd800 && wc < 0xdc00
    if len(a:mb) < 4
      throw "ICONV: RET_TOOFEW"
    endif
    let wc2 = (a:mb[2] * 0x100) + a:mb[3]
