...
function iconv#iso8859_13#new()
  return s:iso8859_13.new()
endfunction

let s:iso8859_13 = {}

function s:iso8859_13.new()
  let obj = copy(self)
  call obj.__init__()
  return obj
endfunction

function s:iso8859_13.__init__()
  " pass
endfunction

function s:iso8859_13.mbtowc(mb)
  let c = a:mb[0]
  if c < 0xa0
    return [1, [c]]
  else
    return [1, [self.iso8859_13_2uni[c-0xa0]]]
  endif
endfunction

function s:iso8859_13.wctomb(wc)
  if a:wc < 0x00a0
    return [a:wc]
  elseif a:wc >= 0x00a0 && a:wc < 0x0180
    let c = self.iso8859_13_page00[a:wc-0x00a0]
  elseif a:wc >= 0x2018 && a:wc < 0x2020
    let c = self.iso8859_13_page20[a:wc-0x2018]
  endif
  if c != 0
    return [c]
  endif
...
function s:iso8859_13.flush()
  return []
endfunction

let s:iso8859_13.iso8859_13_2uni = [
\
...
let s:iso8859_13.iso8859_13_page00 = [
...
let s:iso8859_13.iso8859_13_page20 = [
