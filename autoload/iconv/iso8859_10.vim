...
function iconv#iso8859_10#new()
  return s:iso8859_10.new()
endfunction

let s:iso8859_10 = {}

function s:iso8859_10.new()
  let obj = copy(self)
  call obj.__init__()
  return obj
endfunction

function s:iso8859_10.__init__()
  " pass
endfunction

function s:iso8859_10.mbtowc(mb)
  let c = a:mb[0]
  if c < 0xa0
    return [1, [c]]
  else
    return [1, [self.iso8859_10_2uni[c-0xa0]]]
  endif
endfunction

function s:iso8859_10.wctomb(wc)
  if a:wc < 0x00a0
    return [a:wc]
  elseif a:wc >= 0x00a0 && a:wc < 0x0180
    let c = self.iso8859_10_page00[a:wc-0x00a0]
  elseif a:wc == 0x2015
    let c = 0xbd
  endif
  if c != 0
...
function s:iso8859_10.flush()
  return []
endfunction

let s:iso8859_10.iso8859_10_2uni = [
\
...
let s:iso8859_10.iso8859_10_page00 = [
