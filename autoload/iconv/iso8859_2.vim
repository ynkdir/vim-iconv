...
function iconv#iso8859_2#new()
  return s:iso8859_2.new()
endfunction

let s:iso8859_2 = {}

function s:iso8859_2.new()
  let obj = copy(self)
  call obj.__init__()
  return obj
endfunction

function s:iso8859_2.__init__()
  " pass
endfunction

function s:iso8859_2.mbtowc(mb)
  let c = a:mb[0]
  if c < 0xa0
    return [1, [c]]
  else
    return [1, [self.iso8859_2_2uni[c-0xa0]]]
  endif
endfunction

function s:iso8859_2.wctomb(wc)
  if a:wc < 0x00a0
    return [a:wc]
  elseif a:wc >= 0x00a0 && a:wc < 0x0180
    let c = self.iso8859_2_page00[a:wc-0x00a0]
  elseif a:wc >= 0x02c0 && a:wc < 0x02e0
    let c = self.iso8859_2_page02[a:wc-0x02c0]
  endif
  if c != 0
    return [c]
  endif
...
function s:iso8859_2.flush()
  return []
endfunction

let s:iso8859_2.iso8859_2_2uni = [
\
...
let s:iso8859_2.iso8859_2_page00 = [
...
let s:iso8859_2.iso8859_2_page02 = [
