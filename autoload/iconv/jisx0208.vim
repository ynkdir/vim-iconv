...
function iconv#jisx0208#new()
  return s:jisx0208.new()
endfunction

let s:jisx0208 = {}

function s:jisx0208.new()
  let obj = copy(self)
  call obj.__init__()
  return obj
endfunction

function s:jisx0208.__init__()
  " pass
endfunction

function s:jisx0208.mbtowc(mb)
  let c1 = a:mb[0]
  if (c1 >= 0x21 && c1 <= 0x28) || (c1 >= 0x30 && c1 <= 0x74)
    if len(a:mb) >= 2
      let c2 = a:mb[1]
      if c2 >= 0x21 && c2 < 0x7f
        let i = 94 * (c1 - 0x21) + (c2 - 0x21)
        let wc = 0xfffd
        if i < 1410
          if i < 690
            let wc = self.jisx0208_2uni_page21[i]
          endif
        else
          if i < 7808
            let wc = self.jisx0208_2uni_page30[i-1410]
          endif
        endif
        if wc != 0xfffd
          return [2, [wc]]
...
function s:jisx0208.wctomb(wc)
  let summary = []
  if a:wc >= 0x0000 && a:wc < 0x0100
    let summary = self.jisx0208_uni2indx_page00[bitwise#rshift(a:wc, 4)]
  elseif a:wc >= 0x0300 && a:wc < 0x0460
    let summary = self.jisx0208_uni2indx_page03[bitwise#rshift(a:wc, 4)-0x030]
  elseif a:wc >= 0x2000 && a:wc < 0x2320
    let summary = self.jisx0208_uni2indx_page20[bitwise#rshift(a:wc, 4)-0x200]
  elseif a:wc >= 0x2500 && a:wc < 0x2670
    let summary = self.jisx0208_uni2indx_page25[bitwise#rshift(a:wc, 4)-0x250]
  elseif a:wc >= 0x3000 && a:wc < 0x3100
    let summary = self.jisx0208_uni2indx_page30[bitwise#rshift(a:wc, 4)-0x300]
  elseif a:wc >= 0x4e00 && a:wc < 0x9fb0
    let summary = self.jisx0208_uni2indx_page4e[bitwise#rshift(a:wc, 4)-0x4e0]
  elseif a:wc >= 0xff00 && a:wc < 0xfff0
    let summary = self.jisx0208_uni2indx_pageff[bitwise#rshift(a:wc, 4)-0xff0]
  endif
  if !empty(summary)
    let idx_indx = 0
    let idx_used = 1
    let used = summary[idx_used]
    let i = bitwise#and(a:wc, 0x0f)
    if bitwise#and(used, bitwise#lshift(1, i))
      ...
      let c = self.jisx0208_2charset[summary[idx_indx] + used]
...
let s:jisx0208.jisx0208_2uni_page21 = [
\
...
let s:jisx0208.jisx0208_2uni_page30 = [
\
...
let s:jisx0208.jisx0208_2charset = [
...
let s:jisx0208.jisx0208_uni2indx_page00 = [
\
...
let s:jisx0208.jisx0208_uni2indx_page03 = [
\
...
let s:jisx0208.jisx0208_uni2indx_page20 = [
\
...
let s:jisx0208.jisx0208_uni2indx_page25 = [
\
...
let s:jisx0208.jisx0208_uni2indx_page30 = [
\
...
let s:jisx0208.jisx0208_uni2indx_page4e = [
\
...
let s:jisx0208.jisx0208_uni2indx_pageff = [
\
